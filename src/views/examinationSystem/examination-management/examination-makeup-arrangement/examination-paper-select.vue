<template>
<el-dialog class="t-dialog" v-if="visible" title="抽取试卷" append-to-body :visible="visible" width="60%" @close="close" >
    <!-- 查询 -->
  <el-form :inline="true" size="small">
    ...
    <el-form-item>
      <el-tag type="danger" style="color: #f00;font-weight: 600;">请在列表中选取本次考试中需要的试卷，只能选择一张试卷！</el-tag>
    </el-form-item>
  </el-form>
  <div>
